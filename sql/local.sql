...
CREATE TABLE Assignment.ShoppingOrder(
...
CREATE TABLE Assignment.OrderItem(
	itemID 		INT,
...
ALTER TABLE Assignment.Item ADD CONSTRAINT item_category_fk FOREIGN KEY (categoryID) REFERENCES Category(categoryID);

ALTER TABLE Assignment.OrderItem ADD CONSTRAINT orderitem_item_fk FOREIGN KEY (itemID) REFERENCES Item(itemID);
ALTER TABLE Assignment.OrderItem ADD CONSTRAINT orderitem_shoppingorder_fk FOREIGN KEY (orderID) REFERENCES ShoppingOrder(orderID);
